        ...
        body: Container(
          ...
          child: Stack(children: [
            Positioned(
              ...
              child: Container(
                height: MediaQuery.of(context).size.height*0.2,
                 ...
                 decoration: BoxDecoration(
                  color: Color.fromARGB(255, 47, 59, 143),
              ...
              bottom: 0.h,
              right: 0.w,
              child: Text("YOUR BALANCE",style: TextStyle(fontSize: 35,color: Color.fromARGB(255, 239, 236, 239),fontWeight: FontWeight.w700),)),
            ...
            Positioned(
              ...
              child:Image.asset('assets/images/new.png',fit: BoxFit.cover,), 
              ...
              child:Image.asset('assets/images/piggy2.png',fit: BoxFit.cover,), 
            ...
            Positioned(
              ...
              bottom: 0.h,
              right: 0.w,
              child: Text("RS.${addmoney - expensemoney }",style: TextStyle(fontSize: 35,color: Color.fromARGB(255, 131, 236, 57),fontWeight: FontWeight.w700),)),
            ...
            SafeArea(child: Column(
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        Text("< Back",style: TextStyle(fontSize: 12.sp,color: Color.fromARGB(255, 233, 190, 127)),),),),
                ...
                Container(
                  margin: EdgeInsets.only(right: 8.5.w,left: 8.5.w,top: 50.h),
                           width: 110.w,
                                        height: 10.h,
                                        decoration: BoxDecoration(
                  ...
                  child: Stack(children: [
                     Positioned(
                       ...
                       bottom: 0.h,
                        ...
                        child: Text("MY EXPENSES",style: TextStyle(fontSize: 20.sp,fontWeight: FontWeight.w900,color: Colors.white),),
                      ),
                      Positioned(
                ...
                Container(
                  margin: EdgeInsets.only(right: 8.5.w,left: 8.5.w,top: 5.h),
                           width: 110.w,
                                        height: 10.h,
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(20),
                ...
                child: Stack(children: [
                     Positioned(
                      ...
                      bottom: 0.h,
                        ...
                        child: Text("MY BUDGET",style: TextStyle(fontSize: 20.sp,fontWeight: FontWeight.w900,color: Colors.white),),
                      ),
                       Positioned(
                ...
                Container(
                  ...
                  child: Text("Show ALL Transactions.",style: TextStyle(fontSize: 15.sp,fontWeight: FontWeight.w900,color: Colors.white),),
